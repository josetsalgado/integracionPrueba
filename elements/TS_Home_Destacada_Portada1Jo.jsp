...
<script defer src="<cms:link>/system/modules/com.tfsla.diario.telesur/resources/js/jquery.hc-sticky.min.js</cms:link>"></script>
	...
	<cms:include page="TS_Common_Banners.jsp">
       ...
       <nt:news-list order="priority desc,user-modification-date" zone="destacada" onmainpage="home" size="1" searchindex="<%=index%>">	
      	...
      	<article class="important">
        	...
        	<div class="image fit">
                    ...
                    <div itemprop="image" itemscope itemtype="http://schema.org/ImageObject">
                        ...
                        <nt:preview-image>
                            ...
                            <a href="<nt:link/>" title="${imageDescription}">	
                                ...
                                <%-- img itemprop="contentURL" src="/arte/imagenesJo/pic01.jpg" title="${imageDescription}" alt="${imageDescription}" / --%>
                            </a>
                        </nt:preview-image>			
                    </div>
                    ...
                    <header>
			<h3>
				<a href="<nt:link/>" title="<nt:title value='home' />"> <nt:title value='home' /> </a>
			</h3>
		    </header>
           ...
           <p>
               <nt:sub-title maxlength="153" /> 
           </p>
           <footer style="margin-top:20px">
               <a href="<nt:link/>" class="button special">LEER MÁS</a>
           </footer>
     ...
     <!-- Twitter -->
        ...
        <!-- Notas secundarias -->
        <div>
	  <cms:include page="TS_Home_Destacadas_Secundarias_Portada1Jo.jsp" /> 
	</div>
        <!-- Notas secundarias -->
