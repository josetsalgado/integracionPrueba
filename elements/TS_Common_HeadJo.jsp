...
String Title = (cms.property("Title") == null ) ? "" : "teleSUR" ;
...
%>
	...
	<% if (template.equals("homeIntegracion") || template.equals("americaLatina") || template.equals("ultimasNoticias") || template.equals("videos")){ %>	
		<title><%=Title%></title>
		
		<%-- c:if test="${template.getPSystem() == 'homeIntegracion'}" --%>
		...
		<meta name="twitter:title" content="Noticias teleSUR">
		<meta name="twitter:description" content=".">
		<%-- meta name="twitter:image" content="http://graphics8.nytimes.com/images/2012/02/19/us/19whitney-span/19whitney-span-articleLarge.jpg" --%>
		<meta name="twitter:image" content="http://iparatodos.com.ar/television/fox">
...
<% if (template.equals("home") || template.equals("homeNew") || template.equals("search")){ %>	
	...
	<script>alert('entro en el primer if');</script>
...
<% if (template.equals("news") || template.equals("multimedia") || template.equals("opinion") || template.equals("Analysis") || template.equals("ultimasNoticias") || template.equals("joinus") || template.equals("telesur_agenda") || template.equals("soyreportero")) { %>	
...
<% if (template.equals("article") || template.equals("ultimasNoticias") || template.equals("Analysis") ) { %>	
	<!-- FlexSlider -->
...
<% /** ini blog */ %>
<% if ( template.equals("ultimasNoticias") || template.equals("Analysis") || template.equals("article")  || template.equals("opinion")) { %>	
	<!-- Vertical Carrousel -->
