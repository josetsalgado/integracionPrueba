				...
				<div class="colblogl">
					...
					<div class="contentblog">            
						...
						<div class="col-sixblog">
							...
							<div class="blogrs">
								<a href="<nt:link/>" alt="Leer Más" title="Leer Más" <%-- class="readblog" --%> class="button special" style=" font-size: x-small;
    float: left;border-radius: 43px 43px 43px 43px; margin-top:-5px">Leer Más</a>
