	...
	<article itemscope itemtype="http://schema.org/Article">
		...
		<nt:conditional-include oncondition="${news.homePreview == 'imagen'}">
			<nt:conditional-include oncondition="${news.videoscount > 0}">
				<img <cms:img src="/arte/ico-play.png" width="351" height="25" scaleType="2" scaleColor="transparent" partialTag="true" /> width="35" height="25" alt="Telesur" class="icoPlay" />
			...
			<div itemprop="image" itemscope itemtype="http://schema.org/ImageObject">
				...
				<nt:preview-image>
					...
					<a href="<nt:link/>" title="${imageDescription}" alt="${imageDescription}">	
						...
						<%-- aca --%>
						<img itemprop="contentURL" src="arte/grey.gif" data-original="<nt:image-path width='306' height='172' scaletype='2'/>" width='306' height='172' alt="${imageDescription}" scalePosition="Simapi.POS_CENTER" >
					</a>
		...
		<h2 itemprop="name headline">
			<a href="<nt:link/>" title="<nt:title value='home' />" alt="<nt:title value='home' />">
				<nt:title value="home" maxlength="15" />
			</a>...
		</h2>
