...
Blocks.put("Ultimas Noticias","TS_Home_LastNewsJo.jsp");
Blocks.put("Publicidad-728x90","TS_Home_Publicidad-top.jsp");
...
Blocks.put("Twitter","TS_Home_Twitter_Portada1Jo.jsp");
Blocks.put("Poll","TS_Home_BoxEncuesta.jsp");
...
Blocks.put("ResultadosElecciones", "TS_Home_PersonJo.jsp");
...
Blocks.put("Ranking Opinion","TS_Opinion_Ranking.jsp"); //Opinion y Nota Opinion
...
Blocks.put("Ranking Analisis","TS_Analisis_Ranking.jsp"); //Analisis y Nota Analisis
...
<cms:contentload collector="singleFile" param="/.config/columna_derecha.html" editable="true">
