...
<header class="align-center">
	<h3><a href="http://www.telesurtv.net/SubSecciones/news/latinaamerica/index.html"><h2>América Latina<%-- cms:img src="/arte/redes/latina.png" scaleType="2" alt="Telesur" / --%></h2></a><h3> 
</header>
