...
<ul>
	...
	<li><a href="indexIntegracionJo.jsp" class="active" >Home</a></li>
	<li><a href="genericJo.jsp" class="active" >América Latina</a></li>
	<li><a href="elementsJo.jsp" class="active" >Últimas Noticias</a></li>
	<li><a href="videosJo.jsp" class="active" >Videos</a></li>
<%--
