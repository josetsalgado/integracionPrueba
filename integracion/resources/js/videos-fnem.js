...
jQuery.fn.GetVideos = function(){
	...
	.done(function(data){
		$.each(data,function(i){
			...
			$ASIDE += '<a href="javascript:;" onclick="'+watchVideoFN+'"><img src="'+imagen+'" alt="Telesur" class="icoPlay"></a>';
...
jQuery.fn.GetCorresponsales = function(){
	...
	.done(function(data){
		$.each(data,function(i){
			...
			$LIST += '<a href="http://multimedia.telesurtv.net/web/telesur/#!video/noticia/'+video_slug+'" target="_blank"><img src="'+imagen+'" alt="Telesur" class="icoPlay"></a>';
